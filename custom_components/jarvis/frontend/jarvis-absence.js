/* JARVIS V4.0.0 — absence history and Sentinel timeline. */
...
if(Panel&&!Panel.prototype.__jarvisAbsenceInstalled){
 ...
 Panel.prototype._jarvisInstallAbsenceCard=function(){
  ...
  const card=document.createElement('section');card.className='card';card.id='jarvisAbsenceCard';card.dataset.v4Key='absence';
