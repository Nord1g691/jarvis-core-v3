...
SATELLITE_SETTINGS_FILE = f"{FRONTEND_URL}/jarvis-satellite-settings.js?v={ASSET_VERSION}"
...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    ...
    for asset in (FRONTEND_FILE_VERSIONED, HUD_CONFIG_FILE, SOLAR_BRIDGE_FILE, STABILIZER_FILE, SETTINGS_FILE, SATELLITE_SETTINGS_FILE, UI_LAYER_FILE, MEMORY_UI_FILE):
